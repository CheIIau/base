    ...
    <header class="main-header">
        ...
        <div class="main-header__container container">
            ...
            <?php if (isset($_SESSION['user'])) : ?>
                ...
                <div class="main-header__username-container">
                    <h4 class="greetings">Привет, <?= ($_SESSION['user']['name']) ?> </h4>
                    <h5 class="logout-btn"><a href="logout.php">Выход</a></h5>
                </div>
        ...
        <nav class="nav">
            <ul class="nav__list container">
                <?php foreach ($categories as $key => $value) : ?>
                    <li class="nav__item">
                        <a href="lots.php?category=<? echo $key+1 ; ?>">
                            <?= $value['name']; ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
